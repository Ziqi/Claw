...
> [!TIP]
> **Using a coding agent?** Your agent may not know the latest Gemini API. Run `npx skills add google-gemini/gemini-skills --skill gemini-interactions-api --global` to keep it current. [Set up your coding agent →](https://ai.google.dev/gemini-api/docs/coding-agents#gemini-interactions-api)
